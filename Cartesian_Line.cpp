...
void Cartesian_Line::halfcos_coef()
{
	...
	if (t_interval > 0)
	{
		...
		Halfcos_coef(ZeroVector2, V_traj_length_Dalpha, ZeroVector2, ZeroVector2,method,Tf, V_Vc_Wc, V_Vmax_Wmax, V_Vdmax_Wdmax, Half_coef);
...
Trapez_coef(ZeroVector2, V_traj_length_Dalpha, ZeroVector2, ZeroVector2, method, Tf, V_Vc_Wc, V_Vmax_Wmax, V_Vdmax_Wdmax, Trapez_coefs);
